...
export function getAuthByKey(key: number|string) {
  var auths = localStorage.get(CONFIG_DATA.authKey)
  return auths[key] ? auths[key] : ''
}

export function getParams(data: {}, key: number|string, type:number) {
